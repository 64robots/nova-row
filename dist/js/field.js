...
Nova.booting(function (Vue, router) {
  Vue.component('index-nova-row', __webpack_require__(3));
  Vue.component('detail-nova-row', __webpack_require__(6));
  Vue.component('form-nova-row', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    values: {
      ...
      handler: function handler(values) {
        this.value = values.map(function (value) {
  ...
  mounted: function mounted() {
    ...
    this.values.forEach(function (value) {
      Object.keys(value).forEach(function (key) {
        if (key !== 'row_id') {
          _this2.$refs['' + value.row_id + key][0].handleChange(value[key]);
        }
      });
    });
  },
  ...
  methods: {
    ...
    addItemToRow: function addItemToRow(obj) {
      Object.assign(obj, {
        row_id: Math.random().toString(36).substr(2, 9)
      });
        ...
        [
          ...
          _vm._l(_vm.values, function(row) {
            return _c(
              ...
              {
                key: row.row_id,
                staticClass: "row-container border-40 border relative"
              },
              [
                _vm._l(_vm.fields, function(field) {
                  return _c("form-" + field.component, {
                    ...
                    model: {
                      value: row[field.attribute],
                      callback: function($$v) {
                        _vm.$set(row, field.attribute, $$v)
                      },
                      expression: "row[field.attribute]"
                    }
                  })
                }),
                _vm._v(" "),
